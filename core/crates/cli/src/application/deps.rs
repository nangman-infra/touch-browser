...
pub(super) use crate::interface::cli_models::{
    ...
    ExpandAdapterOutput, ExpandOptions, ExtractCommandOutput, ExtractCommandSummary,
    ExtractOptions, FollowAdapterOutput, FollowOptions, MemorySummaryOutput, OutputFormat,
    PaginateAdapterOutput, PaginateOptions, PaginationDirection, PolicyCommandOutput,
...
pub(super) use touch_browser_contracts::{
    ...
    SearchReport, SearchReportStatus, SearchResultItem, SessionState, SessionSynthesisClaim,
