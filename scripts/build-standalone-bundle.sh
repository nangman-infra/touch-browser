...
export TOUCH_BROWSER_EVIDENCE_EMBEDDING_LAZY_DOWNLOAD="${TOUCH_BROWSER_EVIDENCE_EMBEDDING_LAZY_DOWNLOAD:-1}"
export TOUCH_BROWSER_EVIDENCE_NLI_LAZY_DOWNLOAD="${TOUCH_BROWSER_EVIDENCE_NLI_LAZY_DOWNLOAD:-1}"
