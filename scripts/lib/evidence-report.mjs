...
export function claimOutcomes(report) {
  ...
  return [
    ...evidenceSupportedClaims(report).map((claim) => ({
      ...
      supportSnippets: claim.supportSnippets ?? [],
      verdictExplanation: claim.verdictExplanation ?? null,
      confidenceBand: claim.confidenceBand ?? null,
      reviewRecommended: claim.reviewRecommended ?? false,
      matchSignals: claim.matchSignals ?? null,
